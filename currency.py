...
APIKEY = 'pY0RPNXpXroZemsLkHsf4d60IV4VqTlKBewm6oes4d0e'
...
def get_src(json):
    ...
    return introcs.strip(source_strip,'"')
...
def exchange(src, dst, amt):
    ...
    result1 = get_dst(result)
    result2 = introcs.split(result1, ' ')
